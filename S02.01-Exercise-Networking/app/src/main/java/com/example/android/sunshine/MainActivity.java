...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        new NetworkRequestsAsyncTask().execute(NetworkUtils.buildUrl(preferredWeatherLocation));
    }

    // TODO (5) Create a class that extends AsyncTask to perform network requests
    private class NetworkRequestsAsyncTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... params) {
            ...
            try {
                searchResults = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
            } catch (IOException e){
                e.printStackTrace();
            }
