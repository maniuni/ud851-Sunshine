...
public class MainActivity extends AppCompatActivity
    ...
    private void loadWeatherData() {
        ...
        queryBundle.putString(LOCATION_KEY, location);
    ...
    @Override
    public void onLoadFinished(Loader<String[]> loader, String[] resultData) {

        mLoadingIndicator.setVisibility(View.INVISIBLE);

        if (resultData != null) {
            showWeatherDataView();
            mForecastAdapter.setWeatherData(resultData);
        } else {
            showErrorMessage();
        }
    }
