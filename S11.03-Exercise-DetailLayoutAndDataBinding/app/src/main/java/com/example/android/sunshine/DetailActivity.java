...
//      COMPLETED (8) Use mDetailBinding to display the date
        mDetailBinding.primaryWeatherInfo.tvDate.setText(dateText);
...
//      COMPLETED (15) Create the content description for the description for a11y
        mDetailBinding.primaryWeatherInfo.tvWeatherDescription.setContentDescription(description);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.tvTemperatureHigh.setText(highString);
        mDetailBinding.primaryWeatherInfo.tvTemperatureHigh.setContentDescription(highString);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.tvTemperatureLow.setText(lowString);
        mDetailBinding.primaryWeatherInfo.tvTemperatureLow.setContentDescription(lowString);
        /************
         * Humidity *
         ************/
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeatherDetails.tvHumidityValue.setText(humidityString);
        mDetailBinding.extraWeatherDetails.tvHumidityValue.setContentDescription(humidityString);

//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetails.tvHumidity.setContentDescription(getString(R.string.a11y_humidity));
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetails.tvWindValue.setText(windString);
        mDetailBinding.extraWeatherDetails.tvWindValue.setContentDescription(windString);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetails.tvWind.setContentDescription(getString(R.string.a11y_wind));
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetails.tvPressureValue.setText(pressureString);
        mDetailBinding.extraWeatherDetails.tvPressureValue.setContentDescription(pressureString);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetails.tvPressure.setContentDescription(getString(R.string.a11y_pressure));
