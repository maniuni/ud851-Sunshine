...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherDataList = {
                "Today, windy, low 12 C - high 20C",
                "Tomorrow, quiet, low 15 C - high 22 C",
                "Wednesday, rain, low 10 C - high 15 C",
                "Thursday, rain, low 10 C - high 14 C",
                "Friday, calm, low 12 C - high 15 C",
                "Saturday, sunny, low 14 C - high 18 C",
                "Sunday, sunny, low 15 C - high 22 C"};


        // TODO (4) Append each String from the fake weather data array to the TextView
        for (String weatherDayForecast: weatherDataList) {
            weatherDataTextView.append(weatherDayForecast + "\n\n\n");
        }
    }
}