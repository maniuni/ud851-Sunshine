...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        double highTemperature = mCursor.getDouble(MainActivity.MX_TEMP_INDEX);
        double lowTemperature = mCursor.getDouble(MainActivity.MIN_TEMP_INDEX);
        String highAndLowTemperature = SunshineWeatherUtils.formatHighLows(mContext, highTemperature, lowTemperature);
        int weatherID = mCursor.getInt(MainActivity.WEATHER_ID_INDEX);
